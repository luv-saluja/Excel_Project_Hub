...
🚀 How to Use
Download UPI_Transaction_Dashboard.xlsx
Open in Microsoft Excel (2016 or later recommended for full slicer/chart support)
Use the Filter Panel on the left to slice by City, Gender, Merchant Category, or Merchant Name
All KPIs, charts, and the map update live based on your filter selection
👤 Author

Luv Singh Saluja B.Tech Mechanical Engineering, National Institute of Technology, Raipur LinkedIn · GitHub · HackerRank
